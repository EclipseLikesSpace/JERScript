...
var grammar = {
    ...
    {"name": "lambda", "symbols": [(myLexer.has("lparen") ? {type: "lparen"} : lparen), "_", "param_list", "_", (myLexer.has("rparen") ? {type: "rparen"} : rparen), "_", (myLexer.has("longarrow") ? {type: "longarrow"} : longarrow), "_", "lambda_body"], "postprocess": 
        (data) => {
            return {
                type: "lambda",
                parameters: data[2],
